    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!auth) {
            setUserAuthState({
                user: null,
                isUserLoading: false,
                userError: new Error("Serviço de autenticação não fornecido.")
            });
            return;
        }
        const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$node$2d$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(auth, (firebaseUser)=>setUserAuthState({
                user: firebaseUser,
                isUserLoading: false,
                userError: null
            }), (error)=>{
...
const useStorage = ()=>useFirebase().storage; // CORREÇÃO: Novo hook para o Storage
const useUser = ()=>{
...
"[project]/src/firebase/non-blocking-updates.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function deleteDocumentNonBlocking(docRef, id) {
    let refToDelete;
    if (typeof id !== 'undefined' && 'firestore' in docRef) {
        refToDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(docRef, id);
    } else {
        refToDelete = docRef;
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteDoc"])(refToDelete).catch((error)=>{
        console.error("deleteDocumentNonBlocking failed:", error);
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$error$2d$emitter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["errorEmitter"].emit('permission-error', new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
            path: refToDelete.path,
            operation: 'delete'
        }));
    });
}
...
__turbopack_context__.s([
    ...
    "addDocumentNonBlocking",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addDocumentNonBlocking"],
    "deleteDocumentNonBlocking",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteDocumentNonBlocking"],
    "errorEmitter",
    ...
    "setDocumentNonBlocking",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDocumentNonBlocking"],
    "updateDocumentNonBlocking",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDocumentNonBlocking"],
    "useAuth",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d147ea74._.js.map