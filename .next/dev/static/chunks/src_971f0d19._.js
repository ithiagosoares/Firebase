...
"[project]/src/app/(app)/workflows/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WorkflowsPage() {
    ...
    const workflowsCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "WorkflowsPage.useMemoFirebase[workflowsCollection]": ()=>{
            if (!user) return null;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["collection"])(firestore, `users/${user.uid}/workflows`);
        }
    }["WorkflowsPage.useMemoFirebase[workflowsCollection]"], [
        firestore,
        user
    ]);
    const { data: workflows, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$firestore$2f$use$2d$collection$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCollection"])(workflowsCollection);
    const patientsCollection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemoFirebase"])({
        "WorkflowsPage.useMemoFirebase[patientsCollection]": ()=>{
            if (!user) return null;
    ...
    const handleToggleActive = (id, active)=>{
        if (!user) return;
        const workflowDoc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/workflows/${id}`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDocumentNonBlocking"])(workflowDoc, {
            active
        }, {
            merge: true
        });
    ...
    const handleDeleteWorkflow = (id)=>{
        if (!user) return;
        const workflowDoc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(firestore, `users/${user.uid}/workflows/${id}`);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$non$2d$blocking$2d$updates$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDocumentNonBlocking"])(workflowDoc);
    };
...
_s(WorkflowsPage, "zHRxsvuhS5ql/qV9VMhwflFAqwY=", false, function() {
    return [
...
//# sourceMappingURL=src_971f0d19._.js.map